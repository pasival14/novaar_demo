...
const HeroSection = () => {
    return (
        <div className="sticky flex items-center justify-center h-screen bg-cover bg-center" style={{ backgroundImage: `url(${back})` }}>
            ...
            >
                ...
                <h1 className="text-3xl md:text-5xl font-bold mb-4">Your Dream<br />Our Mission.</h1>
                <p className="text-lg mb-8">Curious about what we have to offer? Let us show you.</p>
                <button className="bg-orange-600 text-white px-4 md:px-6 py-2 md:py-3 rounded-full text-[16px]">
                    <Link to="/contact">
                        Request a Consult
                    </Link>
                </button>
